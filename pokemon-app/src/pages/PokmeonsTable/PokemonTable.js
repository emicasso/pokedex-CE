...
export default function PokemonTable() {
  const { pokemons } = useContext(UsersContext);
  console.log(pokemons)

  return (
    <div className="container mx-auto left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover bg-black">
      <div className="absolute inset-0 z-0" />
      <div className="relative min-h-screen flex flex-col items-center justify-center bg-white">
        <div className="grid mt-8 gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 bg-gray-200 px-4 py-4">

          {/* card */}
          {pokemons.map((item, i) => (
            <div className="flex flex-col">
              <div key={i} className="bg-white shadow-md rounded-3xl p-4">
